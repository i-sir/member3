...
//        'balance' => '余额',
    ...
    public $order_type = [
        ...
        //冻结积分
        310 => '赛事支付成功,发放固定积分(冻结积分)',
        320 => '赛事支付成功,发放奖励积分(冻结积分)',
        330 => '赛事支付成功,发放推荐积分(冻结积分)',
        340 => '赛事支付成功,发放早鸟积分(冻结积分)',

        350 => '赛事取消成功,扣除固定积分(冻结积分)',
        360 => '赛事取消成功,扣除奖励积分(冻结积分)',
        370 => '赛事取消成功,扣除推荐积分(冻结积分)',
        380 => '赛事取消成功,扣除早鸟积分(冻结积分)',

        351  => '赛事完成,扣除固定积分(冻结积分)',
        361  => '赛事完成,扣除奖励积分(冻结积分)',
        371  => '赛事完成,扣除推荐积分(冻结积分)',
        381  => '赛事完成,扣除早鸟积分(冻结积分)',


        //总赛事积分,统计用
        400  => '赛事完成,增加固定积分(总赛事积分)',
        410  => '赛事完成,增加奖励积分(总赛事积分)',
        420  => '赛事完成,增加早鸟积分(总赛事积分)',
